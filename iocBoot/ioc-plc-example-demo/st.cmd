...
#
#         Project: lcls-plc-example-demo.tsproj
#        PLC name: plc_example_demo (plc_example_demo Instance)
...
epicsEnvSet("LOCATION", "PLC:plc_example_demo" )
...
epicsEnvSet("ADS_MAX_PARAMS",   "1104")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_example_demo")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_example_demo:")
dbLoadRecords("caPutLog.db", "IOC=$(IOC)")

## TwinCAT task, application, and project information databases ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_example_demo,IDX=1")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=$(ASYN_PORT), PREFIX=PLC:plc_example_demo")

dbLoadRecords("TwinCAT_Project.db", "PREFIX=PLC:plc_example_demo,PROJECT=lcls-plc-example-demo.tsproj,HASH=unknown,VERSION=unknown,PYTMC=2.15.2.dev0+g73bd2d9.d20230727,PLC_HOST=172.21.148.148")

#   lcls-twincat-motion: * -> 4.0.4 (SLAC)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_demo,DEPENDENCY=lcls-twincat-motion,VERSION=4.0.4,VENDOR=SLAC")
#   Tc2_Standard: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_demo,DEPENDENCY=Tc2_Standard,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc2_System: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_demo,DEPENDENCY=Tc2_System,VERSION=*,VENDOR=Beckhoff Automation GmbH")
#   Tc3_Module: * (Beckhoff Automation GmbH)
dbLoadRecords("TwinCAT_Dependency.db", "PREFIX=PLC:plc_example_demo,DEPENDENCY=Tc3_Module,VERSION=*,VENDOR=Beckhoff Automation GmbH")

cd "$(IOC_TOP)"

## PLC Project Database files ##
dbLoadRecords("plc_example_demo.db", "PORT=$(ASYN_PORT),PREFIX=PLC:plc_example_demo:,IOCNAME=$(IOC),IOC=$(IOC)")

# Total records: 104
callbackSetQueueSize(2208)

# Autosave and archive settings:
save_restoreSet_status_prefix("PLC:plc_example_demo:")
